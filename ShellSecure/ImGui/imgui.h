...
namespace ImGui
{
    ...
    IMGUI_API bool          HyperLink(const char* label, bool underlineWhenHoveredOnly = false);   // button
    IMGUI_API bool          ButtonMulticolored(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding);   // button
    IMGUI_API bool          IcoButton(const char* ico, const char* label, const ImVec2& size = ImVec2(0, 0));   // button
...
enum ImGuiCol_
{
    ...
    ImGuiCol_FrameBgDisabled,               // Background of checkbox, radio button, plot, slider, text input
